...
(function () {
  ...
  const ES = {
    ...
    "tv.detailsPerPane": "Panel de detalles en cada panel",
    ...
    "tv.push": "Enviar ticker a gexbot",
    "tv.push.off": "No", "tv.push.manual": "Manual", "tv.push.auto": "Auto",
    "tv.push.hint": "Desactivado por defecto. La píldora del gráfico muestra un distintivo de grupo — solo aparecen las pestañas de gexbot en <b>modo Ticker</b>. <b>Manual</b>: clic en ➜ para enviar el ticker de este gráfico al grupo seleccionado. <b>Auto</b>: bloquea este gráfico a un grupo (🔓 → 🔒) y envía automáticamente en cada cambio de símbolo — un gráfico por grupo, para que varias pestañas de TV no compitan.",
    "tv.zoom": "Sincronizar zoom del eje Y (bloquea el zoom de gexbot)",
    "tv.zoom.hint": "<b>Solo en Auto + bloqueado.</b> Mientras este gráfico controla un grupo, hacer scroll en el eje de precios de TradingView también mueve el eje Y de gexbot de ese grupo, y el zoom propio de gexbot queda bloqueado (solo lo controla este gráfico). Unidireccional; un envío con escala/instrumento incorrectos se ignora automáticamente.",
    // ---- Watchlist page ----
  ...
  const DYN = {
    en: {
      ...
      "tv.details": "GEX details", "tv.close": "Close", "tv.d.volume": "Volume", "tv.d.oi": "Open interest", "tv.d.maxChg": "Max change GEX",
      ...
      "tv.pushSend": "Push {ticker} → {group} (gexbot Ticker-mode tabs follow)",
      "tv.pushNoGroups": "no groups",
      "tv.pushNone": "No gexbot tabs in Ticker mode — switch a gexbot tab to Ticker mode first",
      "tv.pushNoTicker": "no ticker on this chart",
      "tv.pushNotGex": "{ticker} isn't a GEXbot ticker — nothing to push",
      "tv.pushed": "pushed {ticker} → {group}",
      "tv.zoomOn": "y-axis sync on — this chart drives the group's zoom",
      "tv.pushCycle": "Target group — click to cycle live Ticker-mode groups",
      "tv.pushLock": "Lock this chart to {group} — auto-push its ticker on every change",
      "tv.pushUnlock": "Auto-pushing to {group} — click to unlock",
      "tv.pushLocked": "Locked to this group (auto) — unlock to retarget",
      "tv.pushLockedOther": "Locked by another TV chart",
      "tv.pushLockedMe": "locked to {group} — auto-pushing on change",
      "tv.pushUnlocked": "unlocked {group}",
    ...
    es: {
      ...
      "tv.details": "Detalles GEX", "tv.close": "Cerrar", "tv.d.volume": "Volumen", "tv.d.oi": "Interés abierto", "tv.d.maxChg": "Máx. cambio GEX",
      ...
      "tv.pushCycle": "Grupo destino — clic para alternar entre los grupos activos en modo Ticker",
      "tv.pushSend": "Enviar {ticker} → {group} (las pestañas de gexbot en modo Ticker lo siguen)",
      "tv.pushNoGroups": "sin grupos",
      "tv.pushNone": "Ninguna pestaña de gexbot en modo Ticker — cambia una pestaña de gexbot a modo Ticker primero",
      "tv.pushNoTicker": "sin ticker en este gráfico",
      "tv.pushNotGex": "{ticker} no es un ticker de GEXbot — nada que enviar",
      "tv.pushed": "enviado {ticker} → {group}",
      "tv.zoomOn": "sincronización del eje Y activa — este gráfico controla el zoom del grupo",
      "tv.pushLock": "Bloquear este gráfico a {group} — envía su ticker en cada cambio",
      "tv.pushUnlock": "Enviando automáticamente a {group} — clic para desbloquear",
      "tv.pushLocked": "Bloqueado a este grupo (auto) — desbloquea para cambiar de destino",
      "tv.pushLockedOther": "Bloqueado por otro gráfico de TV",
      "tv.pushLockedMe": "bloqueado a {group} — enviando automáticamente en cada cambio",
      "tv.pushUnlocked": "desbloqueado {group}",
      // replay.js — replay transport bar, review/exit modals, panel-lock blocker (GEXbot, isolated)
